    ...
    <section id="how-it-works" className="py-20 bg-white min-h-screen">
      <div className="max-w-6xl mx-auto px-4 flex flex-col justify-center items-center ">
        ...
        <p className="max-w-4xl p-6 text-center text-lg leading-8">
          ...
          accuracy, tracking movement patterns and generating detailed reports.
          Users simply upload their video files, and Percepta automatically
          scans, detects, and highlights all human activity with precise
