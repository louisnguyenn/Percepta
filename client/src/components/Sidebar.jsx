...
export const Sidebar = () => {
  ...
  const getLinkClassName = path => {
    const baseClasses =
      "flex items-center px-4 py-2 text-slate-700 transition-all duration-300 ease-in-out transform hover:scale-[1.04] hover:shadow-md group relative overflow-hidden rounded-lg";
